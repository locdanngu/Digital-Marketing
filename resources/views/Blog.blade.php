...
<body>
    ...
    @else
    <div class="box d-flex justify-content-center align-items-center" style="height:50vh">
        <div class="d-flex flex-column align-items-center">
            <p class="font-weight-bold" style="font-size:5em;color:#5B5E71;">Hiện không có bài viết</p>
            <i class="bi bi-emoji-frown-fill" style="font-size:5em;color:#5B5E71;"></i>
        </div>
