...
<body>
    ...
    <div class="box box2">
        <div class="phantubox2 d-flex flex-column justify-content-between">
            ...
            <a href="" class="linkbox2">Brief Về Digital Marketing</a>
        </div>
        <div class="phantubox2 d-flex flex-column justify-content-between">
            ...
            <a href="" class="linkbox2">Briefs về triển khai quảng cáo</a>
        </div>
        <div class="phantubox2 d-flex flex-column justify-content-between">
            ...
            <a href="" class="linkbox2">Briefs về PR & Booking</a>
        </div>
        <div class="phantubox2 d-flex flex-column justify-content-between">
            ...
            <a href="" class="linkbox2">Brief Về Video Viral</a>
        </div>
        <div class="phantubox2 d-flex flex-column justify-content-between">
            ...
            <a href="" class="linkbox2">Brief Về Creative Content</a>
        </div>
        <div class="phantubox2 d-flex flex-column justify-content-between">
            ...
            <a href="" class="linkbox2">Brief Về KOLs / Influencer</a>
        </div>
        <div class="phantubox2 d-flex flex-column justify-content-between">
            ...
            <a href="" class="linkbox2">Brief Về TVC Quảng Cáo</a>
        </div>
        <div class="phantubox2 d-flex flex-column justify-content-between">
            ...
            <a href="" class="linkbox2">Brief Về Thuê tài khoản quảng cáo</a>
        </div>
